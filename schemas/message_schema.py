...
class TextMessage(BaseModel):
    ...
    mentions: Optional[List[str]] = Field(default_factory=list, description="Lista de números mencionados na mensagem")
    quoted: Optional[str] = Field(None, description="ID da mensagem citada, se houver")
